...
export const HERO_CONTENT = `Welcome to  CODE-TECH , where innovative web development meets exceptional design. In today’s digital world, your website is often the first impression potential customers have of your business. Make it count with a website that not only looks stunning but performs flawlessly. At CODE-TECH, we specialize in crafting tailor-made web solutions that drive results and elevate your online presence..`;
...
export const CONTACT = {
    ...
    email: "techsiksha1999@gmail.com",
};